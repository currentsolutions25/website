...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      {
        root: null,
        // Bias toward the section occupying the upper mid viewport under the sticky nav
              ...
              <li key={item.href}>
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className={cn(
                      "absolute inset-x-3 -bottom-0.5 h-px origin-center bg-gold-soft transition-transform duration-300",
