...
const variants: Record<"primary" | "secondary" | "gold", CSSProperties> = {
  ...
  secondary: {
    ...
    boxShadow:
      "0 14px 36px -18px rgba(11,58,102,0.22), inset 0 0 0 1px rgba(11,58,102,0.08)",
  },
  gold: {
    background: `linear-gradient(165deg, #E4C65A 0%, ${colors.gold} 48%, #C9A227 100%)`,
    color: colors.navy,
    boxShadow:
...
export default function ScaleButton({
  ...
  const motionProps = {
    whileHover: {
      ...
      boxShadow:
        variant === "gold"
          ? "0 22px 48px -12px rgba(212,175,55,0.7), 0 0 28px -6px rgba(212,175,55,0.45), inset 0 1px 0 rgba(255,255,255,0.4)"
          : variant === "secondary"
            ? "0 18px 40px -16px rgba(11,58,102,0.28), 0 0 22px -8px rgba(212,175,55,0.3), inset 0 0 0 1px rgba(11,58,102,0.1)"
