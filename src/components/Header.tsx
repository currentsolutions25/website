...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 px-3 pt-3.5 sm:px-5 sm:pt-4 lg:px-6 lg:pt-5">
      <div
      ...
      >
        <div className="relative flex items-center justify-between gap-3 px-5 py-3 sm:gap-4 sm:px-6 sm:py-3.5 lg:px-7 lg:py-4">
          <Link
            href="/"
