    ...
    <SiteShell>
      <main>
        ...
        >
          ...
          <div className="relative z-10 mx-auto grid w-full max-w-7xl flex-1 grid-cols-1 content-center items-center px-5 pb-8 pt-12 sm:px-8 sm:pb-10 sm:pt-14 lg:grid-cols-2 lg:px-10 lg:pb-12 lg:pt-16">
            <div className="relative w-full max-w-xl lg:max-w-[36rem]">
              ...
              <motion.p
                ...
                className="mt-6 text-[0.74rem] font-semibold tracking-[0.28em] uppercase sm:mt-8"
              ...
              <motion.h1
                ...
                className="font-display mt-5 text-[clamp(2.85rem,9vw,5.25rem)] font-bold leading-[0.96] tracking-[-0.025em] sm:mt-7 lg:whitespace-nowrap"
              ...
              <motion.p
                ...
                className="font-display mt-5 max-w-[14ch] text-[clamp(1.55rem,5.5vw,2.75rem)] font-medium leading-[1.16] tracking-[-0.018em] sm:mt-8"
                style={{ color: colors.navy }}
              >
              ...
              <motion.div
                ...
                className="mt-6 h-px w-28 origin-left sm:mt-9"
                style={{
              ...
              <motion.p
                ...
                className="mt-6 max-w-md text-base leading-[1.75] sm:mt-9 sm:text-lg sm:leading-[1.85]"
              ...
              <motion.div
                ...
                className="mt-8 flex flex-col gap-3.5 sm:mt-14 sm:flex-row sm:items-center sm:gap-4"
              >
                <Link
                  href="/contact"
                  className="cta-gold hero-cta-primary inline-flex items-center justify-center gap-2.5 rounded-full px-9 py-4.5 text-[0.84rem] font-bold tracking-[0.12em] uppercase sm:py-5"
                  style={{ color: colors.navy }}
                >
                ...
                <a
                  href={PHONE_HREF}
                  className="hero-cta-secondary inline-flex items-center justify-center gap-2.5 rounded-full px-9 py-4.5 text-[0.84rem] font-bold tracking-[0.12em] uppercase sm:py-5"
                  style={{ color: colors.navy }}
                >
